    ...
    extend: {
      ...
      keyframes: {
        ...
        'subtle-pulse': {
          ...
          '70%': { transform: 'scale(1.05)', boxShadow: '0 0 0 15px hsl(var(--primary) / 0)' },
        },
        'subtle-pulse-accent': {
          '0%, 100%': { transform: 'scale(1)', boxShadow: '0 0 0 0 hsl(var(--accent) / 0.7)' },
          '70%': { transform: 'scale(1.05)', boxShadow: '0 0 0 15px hsl(var(--accent) / 0)' },
        },
        'scroll-x': {
      ...
      animation: {
        ...
        'subtle-pulse-accent': 'subtle-pulse-accent 2.5s infinite',
        'scroll-x': 'scroll-x 7s linear infinite',
